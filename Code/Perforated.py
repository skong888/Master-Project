...
file_Name = os.path.join(model_File, fTime+'-Perforated1/')
model_Name = 'perforated.h5'
...
def cnn():
	...
	# Layer 1
	cnn_model.add(Conv2D(32, (3, 3), strides=(2, 2), padding='valid', activation='relu', input_shape=x_train.shape[1:]))
